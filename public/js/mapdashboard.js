...
let map = L.map('map',{layers:light}).setView([-6.2088, 106.8456], 8);
...
async function getData(){
	...
	areas.forEach((area)=>{
		...
		temps.forEach((t,i)=>{
            ...
            if(getDateTime>=dateTime && addTime==false){
                posSuhu=i;
                addTime=true;
            }
            //console.log(getDateTime)
		...
		'</td></tr><tr><td>Keterangan: '+deskripsi+
		'</td></tr><tr><td>Suhu: '+suhu+" °C"+'</td></tr></table>');
