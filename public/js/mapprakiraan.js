...
let map = L.map('map',{layers:light}).setView([-1.605328, 116.9213], 4.5);
...
async function getData(dateTime){
	...
	areas.forEach((area)=>{
		...
		let popUp ='<table width="190px" style="font-family: var(--bs-font-sans-serif); color: #11142d; font-size: 0.73rem;">';
		...
		}).bindPopup('<table style="font-family: var(--bs-font-sans-serif); color: #11142d; font-size: 0.73rem;"><tr><td><strong>Kota: '+prov+
		'</td></tr><tr><td>'+parseDate(nextDate)+
		'</td></tr><tr><td>Keterangan: '+deskripsi+popUp+'</td></tr></table>');
